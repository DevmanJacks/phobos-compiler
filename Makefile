...
TSTOBJS = $(OBJDIR)/ast_test.o $(OBJDIR)/intern_test.o $(OBJDIR)/scanner_test.o $(OBJDIR)/scanner_test.o $(OBJDIR)/source_test.o $(OBJDIR)/token_test.o $(OBJDIR)/testpc.o
...
$(OBJDIR)/testpc.o: $(TSTSRCDIR)/testpc.c $(TSTSRCDIR)/ast_test.h $(TSTSRCDIR)/intern_test.h $(TSTSRCDIR)/source_test.h $(TSTSRCDIR)/token_test.h $(TSTSRCDIR)/testing.h
	$(CC) -c $(DBGCFLAGS) -o $@ $<
