...
# Object files
OBJECTS = $(OBJDIR)/intern.o $(OBJDIR)/source.o $(OBJDIR)/token.o $(OBJDIR)/error.o $(OBJDIR)/scanner.o $(OBJDIR)/ast.o $(OBJDIR)/parser.o $(OBJDIR)/pc.o
TSTOBJS = $(OBJDIR)/error.o $(OBJDIR)/intern_test.o $(OBJDIR)/source_test.o $(OBJDIR)/token_test.o $(OBJDIR)/scanner_test.o $(OBJDIR)/ast.o $(OBJDIR)/parser_test.o $(OBJDIR)/testpc.o
...
$(OBJDIR)/testpc.o: $(TSTSRCDIR)/testpc.c $(TSTSRCDIR)/intern_test.h $(TSTSRCDIR)/source_test.h $(TSTSRCDIR)/token_test.h $(TSTSRCDIR)/scanner_test.h $(TSTSRCDIR)/parser_test.h 
	$(CC) -c $(DBGCFLAGS) -o $@ $<
